...
export const EXCEL_CAPABILITIES: CapabilityManifest = {
  ...
  actuations: [
    ...
    },
    {
      ...
      surface: 'excel',
      title: 'Create table',
      description: 'Promote a worksheet range to a native Excel table.',
      reversible: true,
      appliesTo: ['range'],
    },
    {
      ...
      surface: 'excel',
      title: 'Insert chart',
      description: 'Add a chart over a worksheet source range.',
      reversible: true,
      appliesTo: ['range'],
    },
    {
      ...
      description: 'Add a conditional-formatting rule to a worksheet range.',
      reversible: true,
      appliesTo: ['range'],
    },
    {
