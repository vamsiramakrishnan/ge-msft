...
- `m365 teams app add --filePath development-m365-v0.1.0.zip` uploads a unified app package to an
...
| `dist/package/development/xml/excel.manifest.xml` | Classic Excel Office Add-in manifest |
| `dist/package/development/xml/word.manifest.xml` | Classic Word Office Add-in manifest |
| `dist/package/development/xml/powerpoint.manifest.xml` | Classic PowerPoint Office Add-in manifest |
| `dist/package/development/xml/outlook.manifest.xml` | Classic Outlook Office Add-in manifest |
| `dist/package/development/onenote/onenote.manifest.xml` | Classic OneNote add-in manifest |
| `dist/release/development-m365-v0.1.0.zip` | Unified app package for Microsoft 365 / Teams-style app catalog lanes |
...
| Word/Excel/PowerPoint/Outlook XML manifests | `dist/package/development/xml/*.manifest.xml` | Classic Office add-in sideloading and Centralized Deployment | Teams app catalog upload |
...
| --- | --- |
| Unified package built? | Yes: `dist/release/development-m365-v0.1.0.zip` |
...
m365 teams app add --filePath dist/release/development-m365-v0.1.0.zip
```
