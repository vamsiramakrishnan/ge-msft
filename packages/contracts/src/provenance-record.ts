import type { ProvenancePayload } from './provenance.js';

/**
 * A serialized durable-provenance record for one write, keyed by the write's `changeId`.
 *
 * This pure serializer produces a stable key plus JSON and OOXML custom-XML representations.
 * Word persists the XML part; Excel uses workbook settings JSON. Persistence success and
 * availability remain host-owned receipt fields. No Office.js APIs are called here.
 */
